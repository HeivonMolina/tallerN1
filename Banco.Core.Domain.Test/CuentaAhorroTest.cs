...
namespace Banco.Core.Domain.Test
{
    public class TestsAhorro
    {
        ...
        public void ConsignacionInterMunicipalTest()
        {
            ...
            var cuentaAhorro = new CuentaAhorro(numero: "10001", nombre: "Cuenta Ejemplo", ciudad: "Valledupar");
            //Acción
            var resultado = cuentaAhorro.Consignar(50000, "Barranquilla");
            //Verificación
            Assert.AreEqual("Su Nuevo Saldo es de $60.000,00 pesos m/c", resultado);
        ...
        [Test]
        public void PuedoRetirarCuentaAhorroConCostoTest()
        {
            //Preparar
            var cuentaAhorro = new CuentaAhorro(numero: "10001", nombre: "Cuenta Ejemplo", ciudad: "Valledupar");
            //Acción
            ...
            var resultado = cuentaAhorro.Retirar(10000);
            //Verificación
            Assert.AreEqual("Su retiro fue exitoso. Su nuevo saldo es: 55.000,00 pesos.", resultado);
        }
